...
if __name__=="__main__":
    ...
    #     print(f'train: {train_index}, val: {val_index}')
        ...
        edrvfl = EnsembleDeepRVFL(n_node, lam, w_range, b_range, n_layer)
        edrvfl.train(X_val_train, y_val_train, n_class)
        prediction = edrvfl.predict(X_val_test, False)
        acc = edrvfl.eval(X_val_test, y_val_test)
    ...
    edrvfl = EnsembleDeepRVFL(n_node, lam, w_range, b_range, n_layer)
    edrvfl.train(X_train, y_train, n_class)
    prediction = edrvfl.predict(X_test, False)
    acc = edrvfl.eval(X_test, y_test)
    print(f'\nTest accuracy: {acc}')